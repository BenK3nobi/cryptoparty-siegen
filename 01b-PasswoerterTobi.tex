...
\end{itemize}
\end{frame}
\subsection{Pseudonymität vs Anonymität}
\begin{frame}{Pseudonymität vs Anonymität}
\begin{alertblock}{Pseudonymität}
Ein Pseudonym ist quasi eine zweite Identität welche normal nicht auf die echte Identität zurückschießen lässt, jedoch eine Zuordnung einer Identität.\\

\end{alertblock}
\begin{alertblock}{Anonymität}
...
Der Chip beinhaltet verschlüsselte Informationen die den Kunden identifizieren, zusätzlich muss der Kunde eine Pin zur Bezahlung eingeben.\\
\ \\
\textbf{Nur die Kombination gibt die Freigabe für die Zahlung.}\\
(Ja es gibt inzwischen Einschränkungen.)
\end{frame}
\begin{frame}{2Faktor}
Bei der zwei Faktor Authentifizierung ist das Wichtige, dass es eine Zweite Prüfung deiner Authentizität beweist.\\
\begin{itemize}
\item SMS
\item SmartCard
